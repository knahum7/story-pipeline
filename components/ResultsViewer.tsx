      ...
      <div className="flex items-start justify-between gap-3">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <Pill text={char.role} color={char.role.toLowerCase() === "protagonist" ? "amber" : "default"} />
          </div>
  ...
  return (
    <div className="bg-ink-soft border border-ink-muted rounded-xl overflow-hidden card-hover">
      ...
      <div className="p-4 space-y-3">
        ...
        {scene.narration && (
          <p className="text-sm text-parchment/70 leading-relaxed italic">{scene.narration}</p>
        )}
